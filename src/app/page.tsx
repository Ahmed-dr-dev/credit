      ...
      <header className="border-b border-primary-100/80 bg-white/70 backdrop-blur-md shadow-soft sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex gap-2 items-center">
            <a href="#comment-ca-marche" className="px-4 py-2 rounded-xl text-slate-600 hover:text-primary-600 hover:bg-primary-50 text-sm font-medium transition hidden sm:inline-flex">
              Comment ça marche
            </a>
            <a href="#types-credit" className="px-4 py-2 rounded-xl text-slate-600 hover:text-primary-600 hover:bg-primary-50 text-sm font-medium transition hidden sm:inline-flex">
              Types de crédit
            </a>
            <Link href="/signin" className="px-4 py-2 rounded-xl text-slate-600 hover:text-primary-600 hover:bg-primary-50 text-sm font-medium transition">
              Connexion
            </Link>
            <Link href="/signup" className="px-4 py-2 rounded-xl bg-primary-600 text-white text-sm font-medium hover:bg-primary-700 shadow-soft transition">
              Inscription client
            </Link>
          </nav>
        </div>
